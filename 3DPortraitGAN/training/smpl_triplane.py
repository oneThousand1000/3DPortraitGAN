...
class TriPlaneGenerator(torch.nn.Module):
    def __init__(self,
        ...
        **synthesis_kwargs,         # Arguments for SynthesisNetwork.
        ...
        self.backbone = StyleGAN2Backbone(z_dim, c_dim+6, w_dim, img_resolution=256, img_channels=32*3*rendering_kwargs['triplane_depth'], mapping_kwargs=mapping_kwargs, **synthesis_kwargs)
        ...
        self.bcg_synthesis = SynthesisNetwork(w_dim, img_resolution=self.superresolution.input_resolution,
                                              img_channels=32, **bcg_synthesis_kwargs) if rendering_kwargs.get('use_background', False) else None
